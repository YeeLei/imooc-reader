...
public class BookServiceImpl implements BookService {
    ...
    public void deleteBook(Long bookId) {
        ...
        QueryWrapper<MemberReadState> mrsqWrapper = new QueryWrapper<MemberReadState>();
        mrsqWrapper.eq("book_id", bookId);
        memberReadStateMapper.delete(mrsqWrapper);
