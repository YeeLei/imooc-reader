    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
        <div class="row">
            <div class="col-4 mb-2 pl-0 pr-0">
                <img style="width: 110px;height: 160px;border-radius: 5px; "
                     src="${book.cover}">
            </div>
        ...
        <div class="row" style="background-color: rgba(0,0,0,0.1);">
            <div class="col-2"><h4 class="text-white mt-1">${book.evaluationScore}</h4></div>
            <div class="col-5 pt-2">
                <span class="stars" data-score="${book.evaluationScore}"></span>
            </div>
            <div class="col-5  pt-2">
                <h7 class="text-white">${book.evaluationQuantity}人已评</h7>
            </div>
        </div>
    </div>
